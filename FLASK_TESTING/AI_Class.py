...
class AI:
    def __init__(self, directory):
        ...
        self.collection = self.make_db(self.directory)
    
    def add_to_collection(self, doc):
        """
        Add a document to the Chroma collection.
        """
        self.collection.add(
            documents=[doc],
            ids=["doc" + str(self.collection.count() + 1)],
        )
    ...
    def make_db(self, directory):
        ...
        self.collection = chroma_client.create_collection(name="Rag_collection")
        
        for txt in texts:
            self.add_to_collection(str(txt))
